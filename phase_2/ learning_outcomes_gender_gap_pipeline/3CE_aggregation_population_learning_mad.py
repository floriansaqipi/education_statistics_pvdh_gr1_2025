...
output_dir_path = phase2_path("3CE_aggregation_population_learning_mad")

spark = (
    SparkSession.builder
    .appName("3CE population learning (MAD)")
    .master("local[*]")
    .getOrCreate()
)
...
output_file = os.path.join(output_dir_path, "3CE_country_population_mean_mad_1970_2023.csv")
